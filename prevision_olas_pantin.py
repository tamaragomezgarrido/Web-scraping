...
dataset = {'mes':month,'dia':dia2, 'tramo':momento, 'olas(m/direccion)':olas, 'periodo':periodo, 'energia':energia, 'viento(nudos/direccion)':viento, 'viento(direccion costa)':direccion_viento, 'marea_alta':marea_alta, 'marea_baja': marea_baja,'temperatura mar': sea_temp}
